...
// Replace Edit Modal stakeholders (simpler pattern without placeholder)
const oldEdit = `              <div>
...
if (c.includes(oldEdit)) {
  ...
  // Try to find where the problematic code is
  const idx = c.indexOf('Stakeholders');
  if (idx > -1) {
    console.log('Found Stakeholders at index', idx);
