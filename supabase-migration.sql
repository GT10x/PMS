...
CREATE TABLE IF NOT EXISTS users (
    ...
    username VARCHAR(50) UNIQUE,  -- For regular users (null for admin)
    email VARCHAR(255) UNIQUE,     -- For admin (null for regular users)
...
-- =============================================
-- 4. MODULES TABLE (School ERP Modules)
-- =============================================
CREATE TABLE IF NOT EXISTS modules (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    project_id UUID NOT NULL REFERENCES projects(id) ON DELETE CASCADE,
    module_id VARCHAR(50) NOT NULL,  -- e.g., MOD-001
    name VARCHAR(255) NOT NULL,
    description TEXT,
...
-- Users: Everyone can read, only admins can insert/update/delete
...
-- Module Permissions: Everyone can read their own, admins can manage all
CREATE POLICY "Users can view their module permissions" ON user_module_permissions
    FOR SELECT USING (true);
CREATE POLICY "Admins can manage module permissions" ON user_module_permissions
    FOR ALL USING (true);

-- Projects: Everyone can read, anyone can create, admins can update/delete
...
-- Modules: Everyone can read, anyone can create/update/delete
...
-- Functionalities: Everyone can read and manage
...
-- Tasks: Everyone can read and manage
...
-- Sprints: Everyone can read and manage
...
-- Comments: Everyone can read and manage
